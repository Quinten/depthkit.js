...
DepthKit.Fog=function(a,c){this.depth=c||3E3;this.color=a||"#ffffff";var b=window.parseInt(this.color.slice(1),16);this.aColor="rgba("+(b>>16)+", "+(b>>8&255)+", "+(b&255)+", 0.15)";this.lastZ=this.depth};DepthKit.Fog.prototype.update=function(a,c){c.context.save();c.context.fillStyle=this.aColor;for(this.lastZ=this.lastZ;this.lastZ>a&&0<this.lastZ;this.lastZ-=this.depth/20)c.context.fillRect(0,0,c.canvas.width,c.canvas.height);c.context.restore()};
DepthKit.Fog.prototype.finish=function(a){this.update(0,a);this.lastZ=this.depth};DepthKit.Renderer=function(a,c,b){this.scene=c||new DeptKit.Scene;this.camera=b||new DepthKit.Camera;this.viewport=a||new DepthKit.Viewport;this.fog=void 0};
...
for(e=0;e<this.scene.meshes.length;e++)this.scene.meshes[e].draw(this.viewport.context),void 0!==this.fog&&this.fog.update(this.scene.meshes[e].d,this.viewport);void 0!==this.fog&&this.fog.finish(this.viewport)};if(!window.requestAnimationFrame)window.requestAnimationFrame=window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.msRequestAnimationFrame||window.oRequestAnimationFrame||function(a){return window.setTimeout(a,17)};
...
DepthKit.ObjModel=function(){DepthKit.Mesh.call(this,0,0,0);this.scale=1};DepthKit.ObjModel.prototype=new DepthKit.Mesh;DepthKit.ObjModel.prototype.constructor=DepthKit.ObjModel;DepthKit.ObjModel.prototype.upper=DepthKit.Mesh.prototype;DepthKit.ObjModel.prototype.type="ObjModel";
