var DepthKit=DepthKit||{rad:Math.PI/180,deg:180/Math.PI},DK=DepthKit;DepthKit.Vertex=function(a,c,b){this.x=a||0;this.y=c||0;this.z=b||0;this.d=this.pz=this.py=this.px=0;this.mx=a;this.my=c;this.mz=b};DepthKit.Edge=function(a,c){this.u=a||new DepthKit.Vertex;this.v=c||new DepthKit.Vertex};DepthKit.Edge.prototype.isBehindCamera=function(){return 0>this.u.pz||0>this.v.pz};
DepthKit.Face=function(a,c,b,d){this.a=a||new DepthKit.Vertex;this.b=c||new DepthKit.Vertex;this.c=b||new DepthKit.Vertex;this.color=d||"#cccccc";this.light=void 0};DepthKit.Face.prototype.isBackface=function(){return(this.c.px-this.a.px)*(this.b.py-this.c.py)>(this.c.py-this.a.py)*(this.b.px-this.c.px)};DepthKit.Face.prototype.isBehindCamera=function(){return 0>this.a.pz||0>this.b.pz||0>this.c.pz};DepthKit.Face.prototype.getDepth=function(){return Math.min(this.a.d,this.b.d,this.c.d)};
DepthKit.faceSort=function(a,c){return c.getDepth()-a.getDepth()};DepthKit.Face.prototype.getAdjustedColor=function(){if(void 0===this.light)return this.color;var a=window.parseInt(this.color.slice(1),16),c=a>>16,b=a>>8&255,a=a&255,d=this.getLightFactor();return"#"+("00000"+(c*d<<16|b*d<<8|a*d|0).toString(16)).substr(-6)};
...
DepthKit.SceneObject=function(a,c,b){this.x=a||0;this.y=c||0;this.z=b||0;this.rotationZ=this.rotationY=this.rotationX=0;this.scaleZ=this.scaleY=this.scaleX=1;this.step=this.scene=this.parent=void 0;this.mx=a;this.my=c;this.mz=b;this.rotationMZ=this.rotationMY=this.rotationMX=0;this.scaleMZ=this.scaleMY=this.scaleMX=1};DepthKit.SceneObject.prototype.type="SceneObject";DepthKit.SceneObject.prototype.setScene=function(a){this.scene=a};
DepthKit.SceneObject.prototype.getGlobalX=function(){return this.parent?this.parent.getGlobalX()+this.x:this.x};DepthKit.SceneObject.prototype.getGlobalY=function(){return this.parent?this.parent.getGlobalY()+this.y:this.y};DepthKit.SceneObject.prototype.getGlobalZ=function(){return this.parent?this.parent.getGlobalZ()+this.z:this.z};DepthKit.SceneObject.prototype.initM=function(){};DepthKit.SceneObject.prototype.rotateM=function(){};DepthKit.SceneObject.prototype.scaleM=function(){};
DepthKit.SceneObject.prototype.translateM=function(){};DepthKit.Mesh=function(a,c,b){DepthKit.SceneObject.call(this,a,c,b);this.d=0;this.vertices=[];this.edges=[];this.faces=[];this.strokeColor="#000000";this.strokeWidth=1};DepthKit.Mesh.prototype=new DepthKit.SceneObject;DepthKit.Mesh.prototype.constructor=DepthKit.Mesh;DepthKit.Mesh.prototype.upper=DepthKit.SceneObject.prototype;DepthKit.Mesh.prototype.type="Mesh";
DepthKit.Mesh.prototype.addVertex=function(a,c,b){this.vertices.push(new DepthKit.Vertex(a,c,b));return this};DepthKit.Mesh.prototype.addEdge=function(a,c){this.edges.push(new DepthKit.Edge(a||this.vertices[this.vertices.length-2]||new DepthKit.Vertex,c||this.vertices[this.vertices.length-1]||new DepthKit.Vertex));return this};
DepthKit.Mesh.prototype.addFace=function(a,c,b,d){this.faces.push(new DepthKit.Face(a||this.vertices[this.vertices.length-3]||new DepthKit.Vertex,c||this.vertices[this.vertices.length-2]||new DepthKit.Vertex,b||this.vertices[this.vertices.length-1]||new DepthKit.Vertex,d));return this};DepthKit.Mesh.prototype.applyFillcolor=function(a){for(var c=0;c<this.faces.length;c++)this.faces[c].color=a;return this};
DepthKit.Mesh.prototype.applyLight=function(a){for(var c=0;c<this.faces.length;c++)this.faces[c].light=a;return this};DepthKit.Mesh.prototype.rotateX=function(a){for(var c=Math.cos(a*DK.rad),a=Math.sin(a*DK.rad),b=0;b<this.vertices.length;b++){var d=this.vertices[b].z*c+this.vertices[b].y*a;this.vertices[b].y=this.vertices[b].y*c-this.vertices[b].z*a;this.vertices[b].z=d}return this};
...
DepthKit.Mesh.prototype.draw=function(a){a.save();a.lineWidth=1;this.faces.sort(DK.faceSort);for(var c=0;c<this.faces.length;c++)if(!this.faces[c].isBackface()&&!this.faces[c].isBehindCamera())a.beginPath(),a.moveTo(this.faces[c].a.px,this.faces[c].a.py),a.lineTo(this.faces[c].b.px,this.faces[c].b.py),a.lineTo(this.faces[c].c.px,this.faces[c].c.py),a.lineTo(this.faces[c].a.px,this.faces[c].a.py),a.closePath(),a.fillStyle=a.strokeStyle=this.faces[c].getAdjustedColor(),a.fill(),a.stroke();a.strokeStyle=
this.strokeColor;a.lineWidth=this.strokeWidth;a.beginPath();for(c=0;c<this.edges.length;c++)this.edges[c].isBehindCamera()||(a.moveTo(this.edges[c].u.px,this.edges[c].u.py),a.lineTo(this.edges[c].v.px,this.edges[c].v.py));a.closePath();a.stroke();a.restore()};DepthKit.Mesh.prototype.initM=function(){this.mx=this.x;this.my=this.y;this.mz=this.z;for(var a=0;a<this.vertices.length;a++)this.vertices[a].mx=this.vertices[a].x,this.vertices[a].my=this.vertices[a].y,this.vertices[a].mz=this.vertices[a].z};
...
DepthKit.Renderer=function(a,c,b){this.scene=c||new DeptKit.Scene;this.camera=b||new DepthKit.Camera;this.viewport=a||new DepthKit.Viewport};
DepthKit.Renderer.prototype.render=function(){this.scene.initM();this.scene.rotateM();this.scene.translateM();for(var a=Math.cos(this.camera.tx*DK.rad),c=Math.sin(this.camera.tx*DK.rad),b=Math.cos(this.camera.ty*DK.rad),d=Math.sin(this.camera.ty*DK.rad),f=Math.cos(this.camera.tz*DK.rad),g=Math.sin(this.camera.tz*DK.rad),e=0;e<this.scene.meshes.length;e++){this.scene.meshes[e].d=16777215;for(var h=0;h<this.scene.meshes[e].vertices.length;h++){var j=this.scene.meshes[e].vertices[h].mx-this.camera.x,
k=this.scene.meshes[e].vertices[h].my-this.camera.y,l=this.scene.meshes[e].vertices[h].mz-this.camera.z,m=g*k+f*j,i=b*l+d*m,n=f*k-g*j,o=c*i+a*n,i=a*i-c*n;this.scene.meshes[e].vertices[h].px=this.viewport.vpX+(b*m-d*l-this.camera.ex)*(this.camera.ez/i);this.scene.meshes[e].vertices[h].py=this.viewport.vpY+(o-this.camera.ey)*(this.camera.ez/i);this.scene.meshes[e].vertices[h].pz=i;this.scene.meshes[e].vertices[h].d=Math.sqrt(j*j+k*k+l*l);this.scene.meshes[e].d=Math.min(this.scene.meshes[e].d,this.scene.meshes[e].vertices[h].d)}}this.scene.meshes.sort(DK.meshSort);
for(e=0;e<this.scene.meshes.length;e++)this.scene.meshes[e].draw(this.viewport.context)};if(!window.requestAnimationFrame)window.requestAnimationFrame=window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.msRequestAnimationFrame||window.oRequestAnimationFrame||function(a){return window.setTimeout(a,17)};
if(!window.cancelRequestAnimationFrame)window.cancelRequestAnimationFrame=window.cancelAnimationFrame||window.webkitCancelRequestAnimationFrame||window.mozCancelRequestAnimationFrame||window.msCancelRequestAnimationFrame||window.oCancelRequestAnimationFrame||window.clearTimeout;DepthKit.startTime=(new Date).getTime();DepthKit.getTimer=function(){return(new Date).getTime()-DepthKit.startTime};DepthKit.key={};DepthKit.key.down={UP:!1,DOWN:!1,LEFT:!1,RIGHT:!1,X:!1,C:!1,SPACE:!1};
DepthKit.key.pressed={UP:!1,DOWN:!1,LEFT:!1,RIGHT:!1,X:!1,C:!1,SPACE:!1};
...
DepthKit.key.onKU=function(a){switch(a.keyCode){case 38:DepthKit.key.down.UP=!1;break;case 40:DepthKit.key.down.DOWN=!1;break;case 37:DepthKit.key.down.LEFT=!1;break;case 39:DepthKit.key.down.RIGHT=!1;break;case 88:DepthKit.key.down.X=!1;break;case 67:DepthKit.key.down.C=!1;break;case 32:DepthKit.key.down.SPACE=!1}};DepthKit.key.startCapturing=function(){window.addEventListener("keydown",DepthKit.key.onKD,!1);window.addEventListener("keyup",DepthKit.key.onKU,!1)};
DepthKit.key.stopCapturing=function(){window.removeEventListener("keydown",DepthKit.key.onKD,!1);window.removeEventListener("keyup",DepthKit.key.onKU,!1)};DepthKit.key.unsetPressed=function(){DepthKit.key.pressed.UP=!1;DepthKit.key.pressed.DOWN=!1;DepthKit.key.pressed.LEFT=!1;DepthKit.key.pressed.RIGHT=!1;DepthKit.key.pressed.X=!1;DepthKit.key.pressed.C=!1;DepthKit.key.pressed.SPACE=!1};
...
DepthKit.Engine.prototype.start=function(){this.time=DepthKit.getTimer();this.elapsed=DepthKit.getTimer()-this.time;var a=this;(function b(){frameID=window.requestAnimationFrame(b,a.viewport.canvas);a.elapsed=DepthKit.getTimer()-a.time;a.time=DepthKit.getTimer();a.paintMode||a.viewport.context.clearRect(0,0,a.viewport.canvas.width,a.viewport.canvas.height);a.step(a.scene);a.step(a.light);a.step(a.camera);a.renderer.render();DepthKit.key.unsetPressed()})()};DepthKit.Engine.prototype.stop=function(){window.cancelRequestAnimationFrame(frameID)};
...
DepthKit.Cube.prototype.constructor=DepthKit.Cube;DepthKit.Cube.prototype.upper=DepthKit.Mesh.prototype;DepthKit.Cube.prototype.type="Cube";
DepthKit.Cube.prototype.draw=function(a){this.faces.sort(DK.faceSort);a.save();for(var c=0;c<this.faces.length;c++)if(!this.faces[c].isBackface()&&!this.faces[c].isBehindCamera())a.beginPath(),a.moveTo(this.faces[c].a.px,this.faces[c].a.py),a.lineTo(this.faces[c].b.px,this.faces[c].b.py),a.lineTo(this.faces[c].c.px,this.faces[c].c.py),a.lineTo(this.faces[c].a.px,this.faces[c].a.py),a.closePath(),a.fillStyle=a.strokeStyle=this.faces[c].getAdjustedColor(),a.fill(),a.stroke();a.restore()};
DepthKit.LetterA=function(){DepthKit.Mesh.call(this,0,0,0);this.addVertex(-50,-250,-50);this.addVertex(50,-250,-50);this.addVertex(200,250,-50);this.addVertex(100,250,-50);this.addVertex(50,100,-50);this.addVertex(-50,100,-50);this.addVertex(-100,250,-50);this.addVertex(-200,250,-50);this.addVertex(0,-150,-50);this.addVertex(50,0,-50);this.addVertex(-50,0,-50);this.addVertex(-50,-250,50);this.addVertex(50,-250,50);this.addVertex(200,250,50);this.addVertex(100,250,50);this.addVertex(50,100,50);this.addVertex(-50,
100,50);this.addVertex(-100,250,50);this.addVertex(-200,250,50);this.addVertex(0,-150,50);this.addVertex(50,0,50);this.addVertex(-50,0,50);this.addFace(this.vertices[0],this.vertices[1],this.vertices[8],"#6666cc");this.addFace(this.vertices[1],this.vertices[9],this.vertices[8],"#6666cc");this.addFace(this.vertices[1],this.vertices[2],this.vertices[9],"#6666cc");this.addFace(this.vertices[2],this.vertices[4],this.vertices[9],"#6666cc");this.addFace(this.vertices[2],this.vertices[3],this.vertices[4],
"#6666cc");this.addFace(this.vertices[4],this.vertices[5],this.vertices[9],"#6666cc");this.addFace(this.vertices[9],this.vertices[5],this.vertices[10],"#6666cc");this.addFace(this.vertices[5],this.vertices[6],this.vertices[7],"#6666cc");this.addFace(this.vertices[5],this.vertices[7],this.vertices[10],"#6666cc");this.addFace(this.vertices[0],this.vertices[10],this.vertices[7],"#6666cc");this.addFace(this.vertices[0],this.vertices[8],this.vertices[10],"#6666cc");this.addFace(this.vertices[11],this.vertices[19],
this.vertices[12],"#cc6666");this.addFace(this.vertices[12],this.vertices[19],this.vertices[20],"#cc6666");this.addFace(this.vertices[12],this.vertices[20],this.vertices[13],"#cc6666");this.addFace(this.vertices[13],this.vertices[20],this.vertices[15],"#cc6666");this.addFace(this.vertices[13],this.vertices[15],this.vertices[14],"#cc6666");this.addFace(this.vertices[15],this.vertices[20],this.vertices[16],"#cc6666");this.addFace(this.vertices[20],this.vertices[21],this.vertices[16],"#cc6666");this.addFace(this.vertices[16],
this.vertices[18],this.vertices[17],"#cc6666");this.addFace(this.vertices[16],this.vertices[21],this.vertices[18],"#cc6666");this.addFace(this.vertices[11],this.vertices[18],this.vertices[21],"#cc6666");this.addFace(this.vertices[11],this.vertices[21],this.vertices[19],"#cc6666");this.addFace(this.vertices[0],this.vertices[11],this.vertices[1],"#cccc66");this.addFace(this.vertices[11],this.vertices[12],this.vertices[1],"#cccc66");this.addFace(this.vertices[1],this.vertices[12],this.vertices[2],"#cccc66");
this.addFace(this.vertices[12],this.vertices[13],this.vertices[2],"#cccc66");this.addFace(this.vertices[3],this.vertices[2],this.vertices[14],"#cccc66");this.addFace(this.vertices[2],this.vertices[13],this.vertices[14],"#cccc66");this.addFace(this.vertices[4],this.vertices[3],this.vertices[15],"#cccc66");this.addFace(this.vertices[3],this.vertices[14],this.vertices[15],"#cccc66");this.addFace(this.vertices[5],this.vertices[4],this.vertices[16],"#cccc66");this.addFace(this.vertices[4],this.vertices[15],
this.vertices[16],"#cccc66");this.addFace(this.vertices[6],this.vertices[5],this.vertices[17],"#cccc66");this.addFace(this.vertices[5],this.vertices[16],this.vertices[17],"#cccc66");this.addFace(this.vertices[7],this.vertices[6],this.vertices[18],"#cccc66");this.addFace(this.vertices[6],this.vertices[17],this.vertices[18],"#cccc66");this.addFace(this.vertices[0],this.vertices[7],this.vertices[11],"#cccc66");this.addFace(this.vertices[7],this.vertices[18],this.vertices[11],"#cccc66");this.addFace(this.vertices[8],
this.vertices[9],this.vertices[19],"#cccc66");this.addFace(this.vertices[9],this.vertices[20],this.vertices[19],"#cccc66");this.addFace(this.vertices[9],this.vertices[10],this.vertices[20],"#cccc66");this.addFace(this.vertices[10],this.vertices[21],this.vertices[20],"#cccc66");this.addFace(this.vertices[10],this.vertices[8],this.vertices[21],"#cccc66");this.addFace(this.vertices[8],this.vertices[19],this.vertices[21],"#cccc66")};DepthKit.LetterA.prototype=new DepthKit.Mesh;
DepthKit.LetterA.prototype.constructor=DepthKit.LetterA;DepthKit.LetterA.prototype.upper=DepthKit.Mesh.prototype;DepthKit.LetterA.prototype.type="LetterA";
