...
DepthKit.mouse.attachTo=function(a){var c={x:0,y:0,event:null};a.mousemove=function(b){var d,f;b.pageX||b.pageY?(d=b.pageX,f=b.pageY):(d=b.clientX+document.body.scrollLeft+document.documentElement.scrollLeft,f=b.clientY+document.body.scrollTop+document.documentElement.scrollTop);d-=a.canvas.offsetLeft;f-=a.canvas.offsetTop;c.x=d;c.y=f;c.event=b};a.canvas.addEventListener("mousemove",a.mousemove,!1);a.touchmove=function(b){var d,f;b.touches[0].pageX||b.touches[0].pageY?(d=b.touches[0].pageX,f=b.touches[0].pageY):
(d=b.touches[0].clientX+document.body.scrollLeft+document.documentElement.scrollLeft,f=b.touches[0].clientY+document.body.scrollTop+document.documentElement.scrollTop);d-=a.canvas.offsetLeft;f-=a.canvas.offsetTop;c.x=d;c.y=f;c.event=b};a.canvas.addEventListener("touchmove",a.touchmove,!1);a.mouse=c};DepthKit.mouse.detachFrom=function(a){a.canvas.removeEventListener("mousemove",a.mousemove,!1);a.canvas.removeEventListener("touchmove",a.touchmove,!1);delete a.mouse;delete a.mousemove;delete a.touchmove};
