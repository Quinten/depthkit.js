...
DepthKit.Mesh.prototype.applyFillcolor=function(a){for(var c=0;c<this.faces.length;c++)this.faces[c].color=a;return this};DepthKit.Mesh.prototype.applyLight=function(a){for(var c=0;c<this.faces.length;c++)this.faces[c].light=a;return this};DepthKit.Mesh.prototype.rotateX=function(a){for(var c=Math.cos(a*DK.rad),a=Math.sin(a*DK.rad),b=0;b<this.vertices.length;b++){var d=this.vertices[b].z*c+this.vertices[b].y*a;this.vertices[b].y=this.vertices[b].y*c-this.vertices[b].z*a;this.vertices[b].z=d}return this};
